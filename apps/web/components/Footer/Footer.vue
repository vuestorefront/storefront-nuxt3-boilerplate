<template>
  <footer class="pt-10 bg-neutral-100" data-testid="footer">
    <div
    ...
    <hr />
    <div class="py-10 md:flex md:mx-auto max-w-[1536px]" data-testid="section-middle">
...
import { categories, socialMedia, contactOptions, bottomLinks, companyName } from '../../mocks/footerData';
</script>
