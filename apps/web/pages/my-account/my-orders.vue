    ...
    <table class="hidden md:block text-left typography-text-sm mx-4">
      <thead class="border-b-2 border-neutral-200">
        <tr>
          ...
          <th class="py-4 px-4 font-medium lg:whitespace-nowrap">{{ $t('account.ordersAndReturns.orderDate') }}</th>
          <th class="py-4 px-4 font-medium">{{ $t('account.ordersAndReturns.amount') }}</th>
          <th class="py-4 px-4 font-medium">{{ $t('account.ordersAndReturns.status') }}</th>
